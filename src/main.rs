    ...
    Dispatcher::new(bot)
        .messages_handler(|rx: DispatcherHandlerRx<Message>| {
            rx.for_each(|message| async move {
                ...
                let url = format!("https://login.eveonline.com/oauth/authorize?response_type=code&redirect_uri={}&state={}&client_id={}&scope=esi-markets.structure_markets.v1", redirect_uri, message.update.chat_id(), eve_client_id);
